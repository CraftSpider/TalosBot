...
class TalosDatabase:
    ...
    def set_guild_event(self, guild_id: int, name: str, period: str, channel: int, text: str) -> None: ...

    def update_guild_event(self, guild_id: int, name: str, last_active: int) -> None: ...

    def get_guild_event(self, guild_id: int, name: str) -> Optional[data.GuildEvent]: ...

    def get_guild_events(self, guild_id: int) -> List[data.GuildEvent]: ...

    def remove_guild_event(self, guild_id: int, name: str) -> None: ...
