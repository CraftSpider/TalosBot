...
class DevCommands(dutils.TalosCog):
    ...
    log_channels: Dict[int, logging.Handler] = ...

    def cog_check(self, ctx: commands.Context) -> bool: ...

    def __getattr__(self, item: str) -> dutils.TalosCog: ...
    ...
    async def loghere(self, ctx: commands.Context) -> None: ...
    ...
    async def revoke_title(self, ctx: commands.Context, user: discord.User, *, title: str) -> None: ...
    ...
    async def devtest(self, ctx: commands.Context) -> None: ...
